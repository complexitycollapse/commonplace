...
describe('renderLinks', () => {
  it('returns a RenderLink for each passed link', () => {
    ...
    expect(RenderLinkFactory2(makeNameLinkPairs(links)).renderLinks().map(x => x.link)).toEqual(links)
  });
  ...
  it('does not return a RenderLink if the link was undefined', () => {
    ...
    let renderLinks = RenderLinkFactory2(nameLinkPairs).renderLinks();
  ...
  it('attaches a link to the link it points to', () => {
    ...
    let actual = RenderLinkFactory2(makeNameLinkPairs(links)).renderLinks()[1].modifiers;
  ...
  it('attaches a link to the link it points to, two levels', () => {
    ...
    let actual = RenderLinkFactory2(makeNameLinkPairs(links)).renderLinks();
